				...
				<view class="bmi-bar">
					<view class="bar1 bar-box">
						<view class="scale" :style="{ left: bmiScale ? bmiScale : 0 }" v-if="bmi < 18.5">
							<text class="cuIcon-triangledownfill text-white">
								<text class="tip-bmi" :class="{ 'text-blue': bmi <= 18.5, 'text-cyan': bmi > 18.5 && bmi < 24, 'text-orange': bmi >= 24 && bmi < 28, 'text-red': bmi >= 28 }">
									{{ bmi }}
								</text>
							</text>
						</view>
