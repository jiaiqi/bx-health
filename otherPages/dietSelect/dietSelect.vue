  ...
  <view class="contents">
        ...
        <view class="box">
          <view class="cu-bar search bg-white">
            <view class="search-form round">
              ...
              <input @input="inputChange" :adjust-position="false" v-model="searchValue" @keyup.enter="searchStart"
                type="text" :placeholder="searchInputValue" confirm-type="search" />
            </view>
          </view>
        </view>
      </view>
    ...
    <sPullScroll ref="pullScroll" :heightStyle="heightStyle" :pullDown="pullDown" :pullUp="loadData"
        ...
        <view :data-target="'move-box-' + idx"
          ...
          <view class="smallbox">
            <view class="smallbox-img" >
              ...
              <image width="100%" height="100%" v-else :src="food.imgurl" @click="toPreviewImage(food.imgurl)"></image>
            </view>

            <view class="textbox"  @click.stop="chooseFood(food)">
      ...
      <view class="padding-xl">
        <uni-pagination title="标题文字" :current="pageInfo.pageNo" :total="pageInfo.total" @change="pageChange" class="pagination"></uni-pagination>
      </view>
    </sPullScroll>
