<template>
	<image mode="scaleToFill" class="image-lazy-view no-load" ref="vref" :src="getImagePath(item[imgColName],true)" v-if="item&&imgColName&&item[imgColName]"
	 lazy-load show-menu-by-longpress></image>
	<image mode="scaleToFill" class="image-lazy-view no-load" ref="vref" :src="src" v-else-if="src" :style="{ width: imgWidth + 'px', height: imgHeight + 'px' }"
	 lazy-load show-menu-by-longpress></image>
</template>
<script>
	export default {
