						...
						<view v-for="(monthData, index) in date" :key="index" class="month">
							...
							<view class="month-content">
								...
								>
									...
									<view class="beginTip" v-if="choice === false && !singleDate">请选择截止日期</view>
		...
		dateData: function() {
			...
			if (startIndex1 == endIndex1 && endIndex2 - startIndex2 == 1) {
				if (dataAll2[startIndex1][startIndex2 + 1]) {
					...
					dataAll2[startIndex1][startIndex2 + 1].act.tip = '截至';
			...
			if (islastDay) {
				...
				dataAll2[endIndex1][endIndex2].act.tip = '截至';
