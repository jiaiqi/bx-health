<template>
  <view v-if="service" class="pretty-form">
     <bx-form ref="formRef" :form-app="app" :form-service="service" :form-type="type" ui="pretty" :resultColumn="resultColumn" @v2-loaded="onV2Loaded"></bx-form>
     <view class="button-box" v-if="resultColumn&&showResult===false">
       <button class="cu-btn bg-blue" @click="seeResult">查看结果</button>
     </view>
  </view>
</template>
