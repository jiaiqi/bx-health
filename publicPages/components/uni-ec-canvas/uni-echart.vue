...
<script>
// #ifdef MP-WEIXIN
import uniEcCanvas from '@/publicPages/components/uni-ec-canvas/uni-ec-canvas.vue';
// #endif
// #ifdef H5
import uniEcharts from '@/publicPages/components/uni-ec-canvas/uni-echarts.vue';
// #endif
export default {
	components: {
		// #ifdef MP-WEIXIN
