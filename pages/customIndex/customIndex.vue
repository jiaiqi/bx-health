  ...
  <view class="page-wrap" :style="{
    ...
    <view class="page-item" v-for="pageItem in pageItemList" :class="{
      ...
      <view class="page-menu" v-if="pageItem.div_type === 'buttons'">
        ...
        <swiper class="swiper item-box" :indicator-dots="true" :autoplay="false" :interval="3000" :duration="500"
          v-if="pageItem.buttons && pageItem.buttons.length > 1">
                ...
                if (dest_page.indexOf(self.$api.frontEndAddress) !== -1) {
                  ...
                  uni.navigateTo({
                    url: '/publicPages/webviewPage/webviewPage?webUrl=' +
                      encodeURIComponent(self.$api.frontEndAddress + item.dest_page)
                  });
                }
              }
            }
